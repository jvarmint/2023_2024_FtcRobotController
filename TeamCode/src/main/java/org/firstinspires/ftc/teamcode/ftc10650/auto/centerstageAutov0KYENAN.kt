...
@Autonomous(name = "centerstagev0autov0try1notdone", group = "ftc10650")
class centerstageAutov0KYENAN : ComplexOp() {
...
//            count++
//        }
//        val signalPosition = d.robot.PropDetectionPipeline.id
